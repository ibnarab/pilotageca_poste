...
(
    ...
    periode_prestation                  STRING      COMMENT "Période prestation"                    ,
    annee_prestation                    STRING      COMMENT "Année prestation"                      ,
    mois_prestation                     STRING      COMMENT "Mois prestation"                       ,
    libelle_mois_prestation             STRING      COMMENT "Libellé du mois de prestation"         ,
    periode_facturation                 STRING      COMMENT "Période facturation"                   ,
    annee_facturation                   STRING      COMMENT "Année facturation"                     ,
    mois_facturation                    STRING      COMMENT "Mois facturation"                      ,
    libelle_mois_facturation            STRING      COMMENT "Libellé du mois de facturation"        ,
    periode_comptable                   STRING      COMMENT "Période comptable"                     ,
    annee_comptable                     STRING      COMMENT "Année comptable"                       ,
    mois_comptable                      STRING      COMMENT "Mois comptable"                        ,
